...
class Profile_One extends StatelessWidget {
  const Profile_One({super.key});
             ...
             SizedBox(height: 15,),
              SizedBox(width: 370,
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.pushNamed(context, "Profile_Two");
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor:  Format_Color,
                  ),
                  child: Text('Edit Profile', style: TextStyle(fontSize: 18,color: Colors.black)),
                ),
              ),
            ],
          ),
